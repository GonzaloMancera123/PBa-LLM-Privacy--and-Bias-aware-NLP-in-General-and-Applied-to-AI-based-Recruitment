...
masked_paths = [
    r'c:\Users\Puesto-2\Documents\Gonzalo\NLP\ExtensionRevista\Databases\DbPedia\GPT\35\DBPEDIA_4_anonimizar_LOCanonimizado_CHATGPT.csv',
    r'c:\Users\Puesto-2\Documents\Gonzalo\NLP\ExtensionRevista\Databases\DbPedia\GPT\35\DBPEDIA_4_anonimizar_ORGanonimizado_CHATGPT.csv',
    r'c:\Users\Puesto-2\Documents\Gonzalo\NLP\ExtensionRevista\Databases\DbPedia\GPT\35\DBPEDIA_4_anonimizar_PERanonimizado_CHATGPT.csv',
    r'c:\Users\Puesto-2\Documents\Gonzalo\NLP\ExtensionRevista\Databases\DbPedia\GPT\4nano\DBPEDIA_4_anonimizar_LOCanonimizado_CHATGPT4nano.csv',
    r'c:\Users\Puesto-2\Documents\Gonzalo\NLP\ExtensionRevista\Databases\DbPedia\GPT\4nano\DBPEDIA_4_anonimizar_ORGanonimizado_CHATGPT4nano.csv',
    r'c:\Users\Puesto-2\Documents\Gonzalo\NLP\ExtensionRevista\Databases\DbPedia\GPT\4nano\DBPEDIA_4_anonimizar_PERanonimizado_CHATGPT4nano.csv'
    
    # Add more paths here
]

# Load original data
df_original = pd.read_csv(r'c:\Users\Puesto-2\Documents\Gonzalo\NLP\ExtensionRevista\Databases\DbPedia\DBPEDIA_4_anonimizar.csv')
...
def create_model():
    ...
    y = tf.keras.layers.Dense(70, activation='sigmoid')(out)
...
for masked_path in masked_paths:
    ...
    y_train_one_hot = to_categorical(y_train, num_classes=70)
    y_test_one_hot = to_categorical(y_test, num_classes=70)
