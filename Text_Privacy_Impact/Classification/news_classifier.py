...
def create_model():
    ...
    y = tf.keras.layers.Dense(42, activation='sigmoid')(out)
...
# Define the list of paths for the "masked" datasets
masked_paths = [
    r'c:\Users\Puesto-2\Documents\Gonzalo\NLP\ExtensionRevista\Databases\NewsCategoryDataset\Flair\news_4_anonimizar_LOCanonimizado_FLAIR.csv',
    r'c:\Users\Puesto-2\Documents\Gonzalo\NLP\ExtensionRevista\Databases\NewsCategoryDataset\Flair\news_4_anonimizar_ORGanonimizado_FLAIR.csv',
    r'c:\Users\Puesto-2\Documents\Gonzalo\NLP\ExtensionRevista\Databases\NewsCategoryDataset\Flair\news_4_anonimizar_PERanonimizado_FLAIR.csv',
    r'c:\Users\Puesto-2\Documents\Gonzalo\NLP\ExtensionRevista\Databases\NewsCategoryDataset\Presidio\news_4_anonimizar_LOCanonimizado_PRESIDIO.csv',
    r'c:\Users\Puesto-2\Documents\Gonzalo\NLP\ExtensionRevista\Databases\NewsCategoryDataset\Presidio\news_4_anonimizar_PERanonimizado_PRESIDIO.csv',
    r'c:\Users\Puesto-2\Documents\Gonzalo\NLP\ExtensionRevista\Databases\NewsCategoryDataset\Stanza\news_4_anonimizar_GPEanonimizado_Stanza.csv',
    r'c:\Users\Puesto-2\Documents\Gonzalo\NLP\ExtensionRevista\Databases\NewsCategoryDataset\Stanza\news_4_anonimizar_ORGanonimizado_Stanza.csv',
    r'c:\Users\Puesto-2\Documents\Gonzalo\NLP\ExtensionRevista\Databases\NewsCategoryDataset\Stanza\news_4_anonimizar_PERSONanonimizado_Stanza.csv'
...
# Create test split (original data)
...
for masked_path in masked_paths:
    ...
    y_train_one_hot = to_categorical(y_train, num_classes=42)
    y_test_one_hot = to_categorical(y_test, num_classes=42)
